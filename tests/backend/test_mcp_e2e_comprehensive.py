...
class TestFileReaderToolComprehensive:
    """Comprehensive testing of the file_reader tool with realistic scenarios."""
    
    def test_file_reader_text_file_processing(self, test_client, realistic_test_data):
        """Test file reader with realistic text file content."""
        execution_request = {
            "jsonrpc": "2.0",
            "id": "file_read_text_001",
            "method": "tools/call",
            "params": {
                "name": "file_reader",
                "arguments": {
                    "path": realistic_test_data["file_paths"]["text_file"],
                    "encoding": "utf-8",
        ...
        assert data["id"] == "file_read_text_001"
        assert "result" in data
        assert "content" in data["result"]
    
    def test_file_reader_json_file_processing(self, test_client, realistic_test_data):
        """Test file reader with JSON file content."""
        execution_request = {
            "jsonrpc": "2.0",
            "id": "file_read_json_001",
            "method": "tools/call",
            "params": {
                "name": "file_reader",
                "arguments": {
    ...
    def test_file_reader_csv_file_processing(self, test_client, realistic_test_data):
        """Test file reader with CSV file content."""
        execution_request = {
            "jsonrpc": "2.0",
            "id": "file_read_csv_001",
            "method": "tools/call",
            "params": {
                "name": "file_reader",
                "arguments": {
                    "path": realistic_test_data["file_paths"]["csv_file"],
                    "encoding": "utf-8",
                    "max_size": 256000  # 250KB
                }
            }
        }
    ...
    def test_file_reader_markdown_file_processing(self, test_client, realistic_test_data):
        """Test file reader with markdown file content."""
        execution_request = {
            "jsonrpc": "2.0",
            "id": "file_read_md_001",
            "method": "tools/call",
            "params": {
                "name": "file_reader",
                "arguments": {
                    "path": realistic_test_data["file_paths"]["markdown_file"],
                    "encoding": "utf-8",
                    "max_size": 1048576  # 1MB
                }
            }
    ...
    def test_file_reader_large_file_handling(self, test_client, realistic_test_data):
        """Test file reader with large file handling."""
        execution_request = {
            "jsonrpc": "2.0",
            "id": "file_read_large_001",
            "method": "tools/call",
            "params": {
                "name": "file_reader",
                "arguments": {
                    "path": realistic_test_data["file_paths"]["large_file"],
                    "encoding": "utf-8",
    ...
    def test_file_reader_parameter_validation(self, test_client):
        """Test file reader parameter validation with realistic edge cases."""
        # Test with empty path
        execution_request = {
            "jsonrpc": "2.0",
            "id": "file_read_validation_001",
            "method": "tools/call",
            "params": {
                "name": "file_reader",
                "arguments": {
