...
async def _llm_intent_detection(state: AgentState) -> tuple[str, List[Dict]]:
    ...
    prompt_parts = [
        ...
        "- **document_modification_tool**: Modify Word document content with track changes and comments",
        "",
        ...
        "- **TOOL_WORKFLOW**: Any request requiring research, analysis, content generation, document modification, or multi-step processes",
        "",
        "**DOCUMENT MODIFICATION DETECTION:**",
        "- If user wants to change, modify, replace, edit, or update text in the Word document: use document_modification_tool",
        "- Examples: 'change X to Y', 'replace A with B', 'modify the text', 'edit the document', 'update the author'",
        "",
